import type { UniRequestConfig as HttpRequestConfig } from '@zd~/request/uni'
import type { ResponseResult } from '@zd~/request'
import { UniRequest } from '@zd~/request/uni'
import { ContentTypeEnum, RequestMethodsEnum } from '@zd~/request/shared'
...
export const request = new UniRequest<HttpRequestUserConfig>({
  ...
  request(_config) {
    const config = Object.assign({
      ..._config,
    }) as HttpRequestConfig<HttpRequestUserConfig>
