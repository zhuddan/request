import { ResponseResult, RequiredProperty } from './shared.js';
...
export { type WechatRequestBaseConfig, type WechatRequestConfig, type WechatRequestInterceptors, WxRequest, WxRequest as default };
