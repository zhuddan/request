...
declare class ResponseError<T> extends Error {
    message: string;
    config?: T | undefined;
    constructor(message: string, config?: T | undefined);
}

export { ContentTypeEnum as C, RequestMethodsEnum as R, type ResponseResult as a, type RequiredProperty as b, ResponseError as c };
