import { c as ResponseError, a as ResponseResult } from './shared.d-DkE9HZLg.js';
export { C as ContentTypeEnum, R as RequestMethodsEnum, b as RequiredProperty } from './shared.d-DkE9HZLg.js';
...
declare class HttpRequest<T extends object> {
     ...
     * @param config
     */
    formatFormData(config: AxiosRequestConfig): HttpRequestConfig<T>;
    /**
     * get 请求
     * @param config
     */
...
export { HttpRequest, type HttpRequestBaseConfig, type HttpRequestConfig, type HttpRequestConfigWithoutMethod, type HttpRequestGetConfigWithoutMethod, type HttpRequestInterceptors, ResponseError, ResponseResult };
